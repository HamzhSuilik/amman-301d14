...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(joe.scope() + '*********scope');

Student.prototype.scopeArrow = () => console.log(this);

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(joe.scopeArrow() + '*********arrow');
...
// in scope function this used as object to access the data of the function , but the Arrow function didn't use this to hold data so when we call this the returns is the widow parent of this
